  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        drawer: AppDrawer(), // ✅ رجّعت الدراور
        body: TabBarView(
          children: [
            RemindersTab(),
    ...
    showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(
          // ⬅ عشان نقدر نغير الـ UI جوه الـ Dialog
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                ...
                                if (picked != null) {
                                  setDialogState(() {
                                    selectedTime =
                                        picked; // ⬅ تحديث الوقت جوه الـ Dialog
                                  });
                                }
                              },
                          ...
                          SizedBox(width: 10),
                          Text(
                            _formatTime(selectedTime), // ⬅ عرض الوقت المختار
                            style: TextStyle(
                    ...
                    if (_formKey.currentState!.validate()) {
                      setState(() {
                        medicines.add({
                          ...
                          "time": _formatTime(
                              selectedTime), // 🔥 الوقت بصيغة 12 ساعة
...
// دالة لتنسيق الوقت بصيغة 12 ساعة مع AM/PM
